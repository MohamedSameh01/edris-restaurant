...
export const restaurantInfo = {
  ...
  about: 'مطعم حوش ادريس سيريه هو وجهتك المثالية لتذوق أشهى وألذ المأكولات السودانية الأصيلة. نحن نقدم تجربة طعام فريدة تجمع بين النكهات التقليدية والجودة العالية في أجواء مريحة وودية.',
  location: {
